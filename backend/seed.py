...
def seed(db: Session, asset_count: int = 100, user_count: int = 35, siem_count: int = 120, edr_count: int = 60, cspm_count: int = 35) -> None:
    ...
    # 15. Historical Risk Snapshots (Monthly Progression)
    historical_snapshots = [
        RiskHistory(
            scope="enterprise",
            scope_ref="enterprise",
            scope_label="Enterprise Overall",
            risk_score=Decimal("82.00"),
            likelihood_score=Decimal("0.42000"),
            annual_incident_probability=Decimal("0.62000"),
            financial_impact=Decimal("1105000000.00"),
            expected_annual_loss=Decimal("685000000.00"),
            control_effectiveness=Decimal("0.48000"),
            residual_expected_annual_loss=Decimal("685000000.00"),
            p95_loss=Decimal("1150000000.00"),
            p99_loss=Decimal("1800000000.00"),
            var95=Decimal("1150000000.00"),
            var99=Decimal("1800000000.00"),
            calculation_version="p2-risk-engine-1.0",
            run_id="run-seed-nov",
            created_at=datetime(2025, 11, 15, 0, 0, 0, tzinfo=UTC),
        ),
        RiskHistory(
            scope="enterprise",
            scope_ref="enterprise",
            scope_label="Enterprise Overall",
            risk_score=Decimal("79.00"),
            likelihood_score=Decimal("0.39500"),
            annual_incident_probability=Decimal("0.59500"),
            financial_impact=Decimal("1078000000.00"),
            expected_annual_loss=Decimal("642000000.00"),
            control_effectiveness=Decimal("0.53000"),
            residual_expected_annual_loss=Decimal("642000000.00"),
            p95_loss=Decimal("1080000000.00"),
            p99_loss=Decimal("1700000000.00"),
            var95=Decimal("1080000000.00"),
            var99=Decimal("1700000000.00"),
            calculation_version="p2-risk-engine-1.0",
            run_id="run-seed-dec",
            created_at=datetime(2025, 12, 15, 0, 0, 0, tzinfo=UTC),
        ),
        RiskHistory(
            scope="enterprise",
            scope_ref="enterprise",
            scope_label="Enterprise Overall",
            risk_score=Decimal("77.00"),
            likelihood_score=Decimal("0.37000"),
            annual_incident_probability=Decimal("0.57000"),
            financial_impact=Decimal("1070000000.00"),
            expected_annual_loss=Decimal("610000000.00"),
            control_effectiveness=Decimal("0.57000"),
            residual_expected_annual_loss=Decimal("610000000.00"),
            p95_loss=Decimal("1020000000.00"),
            p99_loss=Decimal("1600000000.00"),
            var95=Decimal("1020000000.00"),
            var99=Decimal("1600000000.00"),
            calculation_version="p2-risk-engine-1.0",
            run_id="run-seed-jan",
        ...
        RiskHistory(
            ...
            likelihood_score=Decimal("0.35000"),
            annual_incident_probability=Decimal("0.55000"),
            financial_impact=Decimal("1050000000.00"),
            expected_annual_loss=Decimal("578000000.00"),
            control_effectiveness=Decimal("0.61000"),
            residual_expected_annual_loss=Decimal("578000000.00"),
            p95_loss=Decimal("980000000.00"),
            p99_loss=Decimal("1520000000.00"),
            var95=Decimal("980000000.00"),
            var99=Decimal("1520000000.00"),
            calculation_version="p2-risk-engine-1.0",
            run_id="run-seed-feb",
        ...
        RiskHistory(
            ...
            likelihood_score=Decimal("0.32000"),
            annual_incident_probability=Decimal("0.54700"),
            financial_impact=Decimal("1000000000.00"),
            expected_annual_loss=Decimal("546893130.00"),
            control_effectiveness=Decimal("0.65000"),
            residual_expected_annual_loss=Decimal("546893130.00"),
            p95_loss=Decimal("941000000.00"),
            p99_loss=Decimal("1480000000.00"),
            var95=Decimal("941000000.00"),
            var99=Decimal("1480000000.00"),
            calculation_version="p2-risk-engine-1.0",
            run_id="run-seed-mar",
            created_at=datetime(2026, 3, 1, 0, 0, 0, tzinfo=UTC),
        ),
    ]
    db.add_all(historical_snapshots)
    db.commit()
